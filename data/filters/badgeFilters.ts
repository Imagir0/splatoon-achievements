export const badgeFilters: Record<string, (b: any) => boolean> = {
  ...
  rankLevel: (b) =>
    ...
    !b.category.includes('NawaBattlerRank') &&
    !b.category.includes('FestRankMax') ||
  ...
  gameModes: (b) =>
    ...
    !b.category.includes('WinCount_HighXPower'),
  ...
  others: (b) =>
    b.category.includes('Lottery') &&
    !b.category.includes('SpendLottery') ||
